...
from django.db import models
from database_subscription.models import DatabaseSubscription  # นำเข้า DatabaseSubscription จาก app database_subscription
...
class DatabaseSearch(models.Model):
    ...
    class Meta:
        ...
        db_table = 'database_search'  # กำหนดชื่อตารางในฐานข้อมูล